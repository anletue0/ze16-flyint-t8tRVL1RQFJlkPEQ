我们在前面随笔《[Vue3+ElementPlus的BS端主从表的快速开发](https://github.com/wuhuacong/p/19138263)》了解了Vue3+ElementPlus的BS端主从表的实现，了解了大概的设计和界面设计方式，我们现在切换一下，看看如何结合FastAPI+WxPython实现主从表界面的展示和编辑处理的。
